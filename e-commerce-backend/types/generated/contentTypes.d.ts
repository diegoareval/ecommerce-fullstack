...
export interface ApiAddresssAddresss extends Schema.CollectionType {
  collectionName: 'addressses';
  info: {
    singularName: 'addresss';
    pluralName: 'addressses';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::addresss.addresss': ApiAddresssAddresss;
